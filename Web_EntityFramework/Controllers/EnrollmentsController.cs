...
namespace Web_EntityFramework.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        {
            ViewBag.CourseID = new SelectList(db.Course.Where(c=>c.Enable == true), "CourseID", "Title");
            ViewBag.StudentID = new SelectList(db.Student.Where(s=>s.Enable==true), "StudentID", "LastName");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "EnrollmentID,Grade,CourseID,StudentID")] Enrollment enrollment)
        {
            ...
            ViewBag.CourseID = new SelectList(db.Course.Where(c=>c.Enable == true), "CourseID", "Title", enrollment.CourseID);
            ViewBag.StudentID = new SelectList(db.Student.Where(s=>s.Enable == true),"StudentID", "LastName", enrollment.StudentID);
            return View(enrollment);
        }
